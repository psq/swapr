...
describe("full test suite", () => {
  ...
  before(async () => {
    ...
    x_token_client = new TokenClient("token1", "SP2NC4YKZWM2YMCJV851VF278H9J50ZSNM33P3JM1", provider)
  ...
  it("should have a valid syntax", async () => {
    ...
    await registryClient.deployContract()  // deploy before swapr
